...
pull_target_dir="c:/my/local/repos/chair/droidmate_dir/dev/droidmate_dir/projects/core/artifacts/apks_ccs2014"
...
tsa_filepath="C:/my/local/repos/chair/droidmate_dir/dev/droidmate_dir/projects/core/artifacts/apks_tsa/TestSubjectApp.apk"
...
#
keystore_path="C:/my/local/repos/chair/droidmate_dir/dev/droidmate_dir/projects/core/src/main/resources/debug.keystore"
function sign_apk() {
...
apktool_path="C:/my/local/repos/chair/droidmate_dir/dev/droidmate_dir/projects/core/src/main/resources/apktool.jar"
function unpack_apk()
{
  apk_path=$1
